...
* - **Starting a project**
  - [Choose your tool versions](explanation/versions) • [Manage charms](howto/manage-charms) • [Initialise your project](howto/initialise-your-project) • [Write and structure charm code](howto/write-and-structure-charm-code)
* - **Running workloads**
