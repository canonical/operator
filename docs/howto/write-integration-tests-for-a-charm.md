...
Save the complete `juju debug-log` logs to disk with the `--juju-dump-logs` option from [pytest-jubilant](https://github.com/canonical/pytest-jubilant#--juju-dump-logs). For example:
