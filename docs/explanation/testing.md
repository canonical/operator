...
- [Jubilant](https://documentation.ubuntu.com/jubilant/) (1.x), which wraps the Juju CLI, together with [`pytest-jubilant`](https://github.com/canonical/pytest-jubilant) (2.x), a pytest plugin that provides fixtures and CLI options for managing Juju models during tests
