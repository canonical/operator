...
class Charm(CharmBase):
    ...
    def __init__(self, *args):
        ...
        self.framework.observe(self.relations['db'].on.joined, self.on_db_relation_joined)
        self.framework.observe(self.relations['mon'].on.changed, self.on_mon_relation_changed)
        self.framework.observe(self.relations['ha'].on.broken, self.on_ha_relation_broken)
