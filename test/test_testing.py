...
class TestTestingModelBackend(unittest.TestCase):
    ...
    def test_network_get_no_net(self):
        harness = Harness(CharmBase, meta='''
            name: app
            ''')
        self.addCleanup(harness.cleanup)
        with self.assertRaises(RelationNotFoundError):
            harness._backend.network_get("no-name")

    def test_network_get_ok(self):
        harness = Harness(CharmBase, meta='''
            name: app
            ''')
        self.addCleanup(harness.cleanup)
        ...
        harness.add_network(network_info, "some-endpoint")
        self.assertDictEqual(network_info, backend.network_get("some-endpoint"))

        harness.add_network(network_info, "other-endpoint", relation_id=23)
        self.assertDictEqual(network_info, backend.network_get("other-endpoint", relation_id=23))

    def test_network_get_reset(self):
        harness = Harness(CharmBase, meta='''
            name: app
            ''')
        self.addCleanup(harness.cleanup)
        ...
        harness.reset_networks()
        with self.assertRaises(RelationNotFoundError):
            backend.network_get("some-endpoint")

    def test_network_get_remove(self):
        harness = Harness(CharmBase, meta='''
            name: app
            ''')
        self.addCleanup(harness.cleanup)
        ...
        harness.remove_network("some-endpoint")
        with self.assertRaises(RelationNotFoundError):
            backend.network_get("some-endpoint")
