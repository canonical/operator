...
class ActionOutput:
    """Contains the logs and results from a :meth:`Harness.run_output` call."""
...
class ActionFailed(Exception):  # noqa
    """Raised when :code:`event.fail()` is called during a :meth:`Harness.run_output` call."""
...
class Harness(Generic[CharmType]):
    ...
    def run_action(self, action_name: str,
        ...
        [jsonschema](https://github.com/python-jsonschema/jsonschema) package to
