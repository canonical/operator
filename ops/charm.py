...
class CloudEventReceivedEvent(CloudEventReceivedEventProxy):
    ...
    def snapshot(self) -> dict:
        ...
        Not meant to be called by charm code.
        """
        return dict(cloud_event_id=self.cloud_event_id)
    ...
    def restore(self, snapshot: dict) -> None:
        ...
        Not meant to be called by charm code.
        """
        self.cloud_event_id = snapshot.get('cloud_event_id', None)
...
class CharmEvents(ObjectEvents):
    ...
    cloud_event_received = EventSource(CloudEventReceivedEventProxy)
...
class CharmBase(Object):
    ...
    def __init__(self, framework: Framework, key: typing.Optional[str] = None):
