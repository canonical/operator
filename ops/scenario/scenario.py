...
from ops.scenario.runtime import Runtime
from ops.scenario.logger import logger as scenario_logger
from ops.scenario.structs import (
    ATTACH_ALL_STORAGES,
    BREAK_ALL_RELATIONS,
...
from ops.scenario.structs import CharmSpec, Event, InjectRelation, Scene, State
...
def generate_startup_scenes(state_template: State):
    yield from (
        ...
        Scene(event=Event("leader-elected" if state_template.leader else "leader-settings-changed"),
