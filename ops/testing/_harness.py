...
from ._core import ActionFailed, ActionOutput, CharmType, ExecArgs, _copy_docstrings
from ._core import _TestingPebbleClient as _CoreTestingPebbleClient
...
class _TestingPebbleClient(_CoreTestingPebbleClient):
    ...
    def __init__(self, backend: _TestingModelBackend, container_root: pathlib.Path):
        super().__init__(container_root)
        self._backend = _TestingModelBackend
        self._layer_dict: Dict[str, pebble.Layer] = {}
        # Has a service been started/stopped?
        self._service_statuses: Dict[str, pebble.ServiceStatus] = {}
    ...
    def _transform_exec_handler_output(
        ...
        if isinstance(data, bytes):
            ...
            if encoding is None:
                ...
                return io.StringIO(cast(str, data))
