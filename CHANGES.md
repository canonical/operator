...
* Use juju.wait for workload version tests in k8s tutorial (#2650)

## Documentation

* Wait longer for Loki data in K8s tutorial integration tests (#2611)
...
* Grab workload version in k8s tutorial (#2559)
* Separate test_workload_version_is_set in k8s tutorial chapter 3 (#2638)
* Add howto configure jubilant logs (#2619)
...
* Switch K8s tutorial charms to rock version of demo server (#2649)
